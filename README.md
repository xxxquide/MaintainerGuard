...
<p align="center">
  ...
  <a href="https://github.com/xxxquide/MaintainerGuard/releases/tag/v0.3.0"><img alt="Latest release" src="https://img.shields.io/github/v/release/xxxquide/MaintainerGuard?label=release"></a>
...
For v0.3.0, `mg init --preset minimal|security|strict|docs` can write a
