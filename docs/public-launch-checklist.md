...
- Confirm the recommended Action usage is `xxxquide/MaintainerGuard@v0.3.0`.
...
- Confirm the latest version is `v0.3.0`.
- Confirm the usage snippet points to the expected version.
- Confirm README rendering looks clean on Marketplace.

## Release and tag

- Confirm `v0.3.0` exists and points to the intended Action metadata release.
